...
function getHTMLForm($mode = '', $authkey = '')
{
    ...
    switch ($mode)
    {
        ...
        case "newdomain":
            ...
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>";
            $form[] = "\t\t\t\t<input type='textbox' name='mxrec[alpha]' id='mxalpha' size='31' value='' />&nbsp;&nbsp;Priority:&nbsp;<input type='textbox' name='priority[alpha]' id='priorityalpha' size='6' value='10' />";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>&nbsp;</td>";
            $form[] = "\t\t</tr>";
            $form[] = "\t\t<tr>";
            ...
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>";
            $form[] = "\t\t\t\t<input type='textbox' name='mxrec[beta]' id='mxbeta' size='31' value='' />&nbsp;&nbsp;Priority:&nbsp;<input type='textbox' name='priority[beta]' id='prioritybeta' size='6' value='20' />";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>&nbsp;</td>";
            $form[] = "\t\t</tr>";
            $form[] = "\t\t<tr>";
            ...
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>";
            $form[] = "\t\t\t\t<input type='textbox' name='mxrec[charley]' id='mxcharley' size='31' value='' />&nbsp;&nbsp;Priority:&nbsp;<input type='textbox' name='priority[charley]' id='prioritycharley' size='6' value='30' />";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>&nbsp;</td>";
            $form[] = "\t\t</tr>";
            $form[] = "\t\t<tr>";
            ...
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>";
            $form[] = "\t\t\t\t<input type='textbox' name='mxrec[delta]' id='mxalpha' size='31' value='' />&nbsp;&nbsp;Priority:&nbsp;<input type='textbox' name='priority[delta]' id='prioritydelta' size='6' value='10' />";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>&nbsp;</td>";
            $form[] = "\t\t</tr>";
            $form[] = "\t\t<tr>";
