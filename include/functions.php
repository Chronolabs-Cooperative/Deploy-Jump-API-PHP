...
function getHTMLForm($mode = '', $authkey = '')
{
    ...
    switch ($mode)
    {
        ...
        case "newdomain":
            ...
            $form[] = "\t\t<tr>";
            $form[] = "\t\t\t<td style='width: 320px;'>";
            $form[] = "\t\t\t\t<label for='mxalpha'>MX Record 1:&nbsp;</label>";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>";
            $form[] = "\t\t\t\t<input type='textbox' name='mxrec[alpha]' id='mxalpha' size='15' value='' style='width: auto; min-width: 40%' />&nbsp;:&nbsp;<input type='textbox' name='priority[alpha]' id='priorityalpha' size='3' value='10' />";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>&nbsp;</td>";
            $form[] = "\t\t</tr>";
            $form[] = "\t\t<tr>";
            $form[] = "\t\t\t<td style='width: 320px;'>";
            $form[] = "\t\t\t\t<label for='mxbeta'>MX Record 2:&nbsp;</label>";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>";
            $form[] = "\t\t\t\t<input type='textbox' name='mxrec[beta]' id='mxbeta' size='15' value='' style='width: auto; min-width: 40%' />&nbsp;:&nbsp;<input type='textbox' name='priority[beta]' id='prioritybeta' size='3' value='20' />";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>&nbsp;</td>";
            $form[] = "\t\t</tr>";
            $form[] = "\t\t<tr>";
            $form[] = "\t\t\t<td style='width: 320px;'>";
            $form[] = "\t\t\t\t<label for='mxcharley'>MX Record 3:&nbsp;</label>";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>";
            $form[] = "\t\t\t\t<input type='textbox' name='mxrec[charley]' id='mxcharley' size='15' value='' style='width: auto; min-width: 40%' />&nbsp;:&nbsp;<input type='textbox' name='priority[charley]' id='prioritycharley' size='3' value='30' />";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>&nbsp;</td>";
            $form[] = "\t\t</tr>";
            $form[] = "\t\t<tr>";
            $form[] = "\t\t\t<td style='width: 320px;'>";
            $form[] = "\t\t\t\t<label for='mxdelta'>MX Record 4:&nbsp;</label>";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>";
            $form[] = "\t\t\t\t<input type='textbox' name='mxrec[delta]' id='mxdelta' size='15' value='' style='width: auto; min-width: 40%' />&nbsp;:&nbsp;<input type='textbox' name='priority[delta]' id='prioritydelta' size='3' value='40' />";
            $form[] = "\t\t\t</td>";
            $form[] = "\t\t\t<td>&nbsp;</td>";
            $form[] = "\t\t</tr>";
            $form[] = "\t\t<tr>";
