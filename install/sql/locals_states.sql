DROP TABLE `locals_states`;

CREATE TABLE `locals_states` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `states_index` (`state`,`country-id`,`abbr`),
  KEY `states_search` (`longitude`,`latitude`,`places-key`),
  KEY `states_statistician_idx` (`hour-start`,`hour-ended`,`week-start`,`week-ended`,`fortnight-start`,`fortnight-ended`,`month-start`,`month-ended`,`quarter-start`,`quarter-ended`,`year-start`,`year-ended`)
