...
CREATE TABLE `tlds` (
  ...
  `tld` varchar(250) NOT NULL  DEFAULT '',
  `class` varchar(32) NOT NULL  DEFAULT '',
  `fallout` varchar(16) NOT NULL  DEFAULT '',
  `ipv4` varchar(32) NOT NULL  DEFAULT '',
  `ipv6` varchar(128) NOT NULL  DEFAULT '',
  `focus-emailing` int(11) UNSIGNED NOT NULL DEFAULT '0',
  `focus-emails` int(11) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `focus-ipv4-company` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv4-registrar-email` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv4-admin-email` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv4-tech-email` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv4-bill-email` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv6-company` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv6-registrar-email` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv6-admin-email` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv6-tech-email` varchar(200) NOT NULL DEFAULT '',
  `focus-ipv6-bill-email` varchar(200) NOT NULL DEFAULT '',
  `focus-tld-company` varchar(200) NOT NULL DEFAULT '',
  `focus-tld-registrar-email` varchar(200) NOT NULL DEFAULT '',
  `focus-tld-admin-email` varchar(200) NOT NULL DEFAULT '',
  `focus-tld-tech-email` varchar(200) NOT NULL DEFAULT '',
  `focus-tld-bill-email` varchar(200) NOT NULL DEFAULT '',
  `focus-generator` varchar(200) NOT NULL DEFAULT '',
  `dns-checked-callback-url-txt-record` int(11) UNSIGNED NOT NULL DEFAULT '0',
  `jumpapi-callback-url-hits` varchar(200) NOT NULL DEFAULT '',
  `jumpapi-callback-url-stats` varchar(200) NOT NULL DEFAULT '',
